...
export class BasePage {
  ...
  constructor(page: Page) {
    ...
    this.linkFacebook = this.barHeaderDetails.locator(
      ".social_icons .facebook"
    );
    this.linkTwitter = this.barHeaderDetails.locator(".social_icons .twitter");
    this.linkLinkedin = this.barHeaderDetails.locator(
  ...
  async goto() {
    this.url ? await this.page.goto(this.url) : await this.page.goto("/");
  }
